...
ice = np.array([255, 255, 255])  # label 0
...
def parse_args():
    ...
    parser.add_argument("--img-dir", default="D:/GeoSeg-main/data/vaihingen/train_images")
    parser.add_argument("--mask-dir", default="D:/GeoSeg-main/data/vaihingen/train_masks")
    parser.add_argument("--output-img-dir", default="D:/GeoSeg-main/data/vaihingen/train/images_1024")
    parser.add_argument("--output-mask-dir", default="D:/GeoSeg-main/data/vaihingen/train/masks_1024")
...
def rgb_to_2D_label(_label):
    ...
    label_seg[np.all(_label.transpose([1, 2, 0]) == ice, axis=-1)] = 1
    ...
    label_seg[np.all(_label.transpose([1, 2, 0]) == bg, axis=-1)] = 0
    return label_seg
