...
class cacd2net(nn.Module):
    def __init__(self, input_nbr=3, label_nbr=2):
        ...
        self.conv = nn.Conv2d(in_channels=1, out_channels=label_nbr,kernel_size=1)
    ...
    def forward(self, x1, x2):
        ...
        out = self.conv(F.upsample(coarse_out, x_size[2:], mode='bilinear') + F.upsample(result_1, x_size[2:], mode='bilinear') + F.upsample(result_2,  x_size[2:], mode='bilinear'))
